...
<body>
    ...
    <div class="row text-center">
                        ...
                        <h5>Usa questa sezione per aggiungere un nuovo Operatore: <br /></h5>
                        ...
                        <input type="text" class="form-control" placeholder="Iban" aria-label="Iban" aria-describedby="basic-addon1">
                        </div>

                        <div class="input-group mb-3">
                        <span class="input-group-text" id="basic-addon1">Data Assunzione</span>
                        <input type="date" name="mydatetime" aria-describedby="basic-addon1">
                        ...
                        <div class="col-12">
                          <br>
                        <button class="btn btn-primary" type="submit">Aggiungi Operatore</button>
                          <br>
                          <br>
                         </div>
